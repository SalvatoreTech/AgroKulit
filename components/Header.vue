                ...
                <div id="navbar-toggle"
                    ...
                    <div class="MenuList flex justify-between py-5">
                        <ul class="font-bodoni flex flex-col gap-2">
                            <li v-for="(link, i) in links" :key="i" class="stagg">
                                <NuxtLink :to="link.path" class=" relative after:bg-black after:absolute after:h-[0.10rem] after:w-0 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-300">
                                  {{ link.title }}
                                </NuxtLink>
                            </li>
                        </ul>
