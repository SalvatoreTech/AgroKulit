    ...
    <div class="bg-white text-white">
        ...
        <div class="Men bg-white text-black paddingXY">
            <div class="flex justify-between items-center lg:flex-row flex-col lg:gap-0 gap-2">
                ...
                <div class="Filter flex flex-wrap gap-2 w-fit">
                    ...
                    <select v-model="category" @change="refresh"
                        class=" p-1 text-xs text-gray-900 cursor-pointer border outline-none border-gray-300 rounded-lg bg-transparent dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-700">
            ...
            <div role="alert" class="alert alert-success text-white" v-if="submittedAdd">
                ...
                <span>The category {{ selectedMen.nama }} was successfully added.</span>
            </div>
