<template>
    <div class="bg-white text-white ">
        <div class="bg-login flex justify-between">
            <div class="paddingX flex flex-col justify-evenly bg-[#767676]/90 rounded-e-xl layer shadow-xl">
                ...
                <div class="FormLayer max-w-full flex flex-col gap-8 content-center">
                    ...
                    <form class="max-w-full mx-auto" autocomplete="off">
                        ...
                        <NuxtLink to="/admin/">
                            <input type="submit" value="Send"
                                class="stagg float-end text-white bg-transparent hover:bg-[#1C3D32] hover:border-[#1C3D32] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-transparent border">
                        </NuxtLink>
                    </form>
                </div>
            </div>
