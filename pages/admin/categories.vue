<template>
    <div class="bg-white text-white">
        ...
        <div class="category bg-white text-black paddingXY">
            <div class="flex justify-between lg:flex-row flex-col lg:gap-0 gap-2 items-center">
            ...
            <div class="Listcategory font-lora lg:mt-2 mt-10">
                ...
                <div v-else class="mt-2">
                    <div v-for="category in categories" :key="category.id"
                        ...
                        <p class="w-5/12">{{ category.nama }}</p>
