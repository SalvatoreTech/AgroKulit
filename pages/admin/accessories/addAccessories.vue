          ...
          <div class="Product">
              <form @submit.prevent="addJacket" autocomplete="off" class="flex flex-col gap-3">
                  ...
                  <div class="flex justify-between gap-10">
                      <div class="General_info font-lora bg-[#ebedec] rounded-md outline-none p-3 w-[50%] flex flex-col gap-2">
                          ...
                          <div class="relative flex flex-col">
                              ...
                              <input v-model.trim="form.nama" name="name" type="text"
                                  ...
                                  placeholder="Ex (Agro-25)">
                          </div>
                          <div class="relative flex flex-col">
                              <label for="description">Product Description</label>
                              <textarea v-model="form.keterangan" name="description"
                                  class="bg-white placeholder:text-[#4e4e4e] rounded-md p-1 outline-none"
                                  placeholder="Ex (Quality genuine cowhide leather...)"></textarea>
                          </div>
                          <div class="flex flex-wrap items-center gap-10">
                              <div class="relative w-2/5">
                                  <label for="gender">Gender</label>
                                  <!-- <div v-for="gender in genders" :key="gender">
                                      <input type="checkbox" :id="gender" :value="gender.id" v-model="form.gender" />
                                      <label :for="gender">{{ gender }}</label>
                                  </div> -->
                              ...
                              <div class="relative flex flex-col w-2/5">
                                  ...
                                  <input v-model.trim="form.harga" name="price" type="number" min="0"
                                      class="bg-white placeholder:text-[#4e4e4e] rounded-md p-1 outline-none"
                                      placeholder="0">
                              </div>
                              <div class="relative flex flex-col w-2/5">
                                  <label for="stock">Stock</label>
                                  <input v-model.trim="form.stok" name="stock" type="number" min="0"
                                      class="bg-white placeholder:text-[#4e4e4e] rounded-md p-1 outline-none"
                                      placeholder="0">
                              </div>
                          </div>
