<template>
  <div class="bg-white text-black">
    <div class="EditProduct paddingXY h-screen">
      <p class="font-lora text-3xl font-medium">Edit Accessory</p>
          ...
          <div class="flex justify-between gap-10">
            <div class="General_info font-lora bg-[#ebedec] rounded-md outline-none p-3 w-[50%]">
              ...
              <div class="relative flex flex-col">
                ...
                <input v-model="product.nama" name="name" type="text"
                  class="bg-white placeholder:text-black rounded-md p-1 outline-none" placeholder="Product Name">
              </div>
              <div class="relative flex flex-col">
            ...
            <div class="Photos bg-[#ebedec] w-[50%] rounded-md p-3">
              ...
              <div class="flex flex-col items-center justify-center">
                ...
                <input type="file" accept="image/*" class="form-control" id="uploadImage" @change="imagePicked"
                  name="photo">
              </div>
            </div>
          </div>
