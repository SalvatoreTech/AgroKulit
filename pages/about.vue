<template>
    ...
    <div class="Story bg-white text-black">
        <img src="../assets/img/Story.jpg" alt="Story" class="w-full"/>
        <div class="Desc paddingX">
        <p class="font-bodoni text-[41px]">Our Story</p>
        <p class="font-lora">
            Agro yang berasal dari singkatan (Anak Garut Rea Order), yaitu seorang
            owner yang lahir di garut dan berkuliah di jurusan Agronomi dengan
            membuka peluang usaha konveksi jaket kulit yang di dirikan pada 25
            Oktober 1995.
        </p>
        </div>
